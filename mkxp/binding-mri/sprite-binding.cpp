...
DEF_PROP_OBJ_REF(Sprite, Bitmap, Pattern, "pattern")
...
DEF_PROP_I(Sprite, PatternBlendType)
DEF_PROP_I(Sprite, PatternOpacity)
DEF_PROP_I(Sprite, PatternScrollX)
DEF_PROP_I(Sprite, PatternScrollY)
...
DEF_PROP_F(Sprite, PatternZoomX)
DEF_PROP_F(Sprite, PatternZoomY)

DEF_PROP_B(Sprite, Mirror)
DEF_PROP_B(Sprite, PatternTile)
DEF_PROP_B(Sprite, Invert)
