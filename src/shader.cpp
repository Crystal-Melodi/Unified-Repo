...
**
** Pattern support is taken from mkxp-z
*/
...
#include "sprite.frag.opt.xxd"
#include "hue.frag.opt.xxd"
#include "trans.frag.opt.xxd"
#include "transSimple.frag.opt.xxd"
#include "bitmapBlit.frag.opt.xxd"
#include "plane.frag.opt.xxd"
#include "gray.frag.opt.xxd"
#include "flatColor.frag.opt.xxd"
#include "simple.frag.opt.xxd"
#include "simpleColor.frag.opt.xxd"
#include "simpleAlpha.frag.opt.xxd"
#include "simpleAlphaUni.frag.opt.xxd"
#include "flashMap.frag.opt.xxd"
#include "minimal.vert.opt.xxd"
#include "simple.vert.opt.xxd"
#include "simpleColor.vert.opt.xxd"
#include "sprite.vert.opt.xxd"
#include "blur.frag.opt.xxd"
#include "simpleMatrix.vert.opt.xxd"
#include "blurH.vert.opt.xxd"
#include "blurV.vert.opt.xxd"
#include "tilemapvx.vert.opt.xxd"

#ifdef MKZP_Z
#include "tilemapz.frag.opt.xxd"
#include "tilemapz.vert.opt.xxd"
#else
#include "tilemap.vert.opt.xxd"
#endif


#define INIT_SHADER(vert, frag, name) \
{ \
	Shader::init(mkxp_shader_##vert##_vert_opt, mkxp_shader_##vert##_vert_opt_len, mkxp_shader_##frag##_frag_opt, mkxp_shader_##frag##_frag_opt_len, \
	#vert, #frag, #name); \
}
...
{
#ifdef MKZP_Z
	INIT_SHADER(tilemapz, tilemap, TilemapShader);
#else
